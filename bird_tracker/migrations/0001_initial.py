    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('training', models.IntegerField(choices=[(0, 'Featherplay'), (1, 'Faustappel'), (2, 'Free Flight')], default=0)),
                ...
                ('notable_image', cloudinary.models.CloudinaryField(default='placeholder', max_length=255, verbose_name='image')),
